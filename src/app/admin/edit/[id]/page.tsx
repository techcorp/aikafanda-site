...
export default function EditBlogPage({ params }: EditBlogPageProps) {
    ...
    async function initPage() {
      ...
      try {
        ...
        if (found) {
          ...
          setCategory(found.category || "Agentic AI");
          setTags(found.tags || "");
          setAuthorName(found.author_name || "");
          setReadTime(found.read_time || "5 min read");
          ...
          setErrorMsg("Blog post not found in database.");
        }
      } catch (err) {
        console.error("Failed to load blog record:", err);
        setErrorMsg("Failed to load blog post from database.");
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      // Check slug uniqueness (if slug was changed)
      ...
      if (updated) {
        ...
        setErrorMsg("Failed to update blog record in database.");
      }
    } catch (err: any) {
  ...
  if (checkingAuth || loadingBlog) {
    return (
      <div className="edit-blog-loading-sec">
        <div className="edit-blog-spinner" />
        <p>Loading database records...</p>
        <style jsx>{`
          .edit-blog-loading-sec {
            min-height: 100vh;
            display: flex;
  ...
  return (
    <main className="edit-blog-wrapper">
      <div className="edit-blog-glow bg-1" />
      <div className="edit-blog-glow bg-2" />
      ...
      <section className="container edit-blog-container">
        ...
        <form onSubmit={handleSubmit} className="edit-blog-form">
          ...
          <div className="form-action-row">
            ...
            >
              {saving ? "Updating Record..." : "Save Updates"}
            </button>
